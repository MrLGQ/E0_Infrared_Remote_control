...
void CAN_FilterInit(CAN_FilterInitTypeDef* CAN_FilterInitStruct)
{
    ...
    /* Initialisation mode for the filter */CAN1->FMR |= FMR_FINIT;

    /* Filter Deactivation */CAN1->FA1R &= ~(uint32_t) filter_number_bit_pos;
    ...
    if (CAN_FilterInitStruct->CAN_FilterScale == CAN_FilterScale_16bit)
    {
        ...
        /* Or First 16-bit identifier and Second 16-bit identifier */CAN1->sFilterRegister[CAN_FilterInitStruct->CAN_FilterNumber].FR1 =
                ((0x0000FFFF
    ...
    if (CAN_FilterInitStruct->CAN_FilterScale == CAN_FilterScale_32bit)
    {
        ...
        /* 32-bit identifier or First 32-bit identifier */CAN1->sFilterRegister[CAN_FilterInitStruct->CAN_FilterNumber].FR1 =
...
void CAN_SlaveStartBank(uint8_t CAN_BankNumber)
{
    ...
    /* Enter Initialisation mode for the filter */CAN1->FMR |= FMR_FINIT;

    /* Select the start slave bank */CAN1->FMR &= (uint32_t) 0xFFFFC0F1;
