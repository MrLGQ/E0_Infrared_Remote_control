...
#elif defined (STM32F10X_LD_VL) || defined (STM32F10X_MD_VL) || defined (STM32F10X_HD_VL)
        /*  PLL configuration:  = (HSE / 2) * 3 = 24 MHz */
        RCC->CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE | RCC_CFGR_PLLMULL));
        RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_PREDIV1 | RCC_CFGR_PLLXTPRE_PREDIV1_Div2 | RCC_CFGR_PLLMULL3);//stm32f100 ΪRCC_CFGR_PLLMULL3
#else    
...
static void SetSysClockTo36(void)
{
    ...
    if (HSEStatus == (uint32_t)0x01)
    {
        ...
        RCC_PLLConfig(RCC_PLLSource_HSE_Div2, RCC_PLLMul_4); //2013-10-17
#endif /* STM32F10X_CL */
...
static void SetSysClockTo48(void)
{
    ...
    if (HSEStatus == (uint32_t)0x01)
    {
        ...
        RCC_PLLConfig(RCC_PLLSource_HSE_Div2, RCC_PLLMul_6); //2013-10-12
#endif /* STM32F10X_CL */
...
static void SetSysClockTo72(void)
{
    ...
    if (HSEStatus == (uint32_t) 0x01)
    {
        ...
        RCC_PLLConfig(RCC_PLLSource_HSE_Div1, RCC_PLLMul_9); //2014-4-17
        //RCC_PLLConfig(RCC_PLLSource_HSE_Div2, RCC_PLLMul_9); //2013-8-7
