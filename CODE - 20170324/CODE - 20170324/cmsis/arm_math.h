...
__STATIC_INLINE void arm_clarke_f32(float32_t Ia, float32_t Ib,
...
__STATIC_INLINE void arm_clarke_q31(q31_t Ia, q31_t Ib, q31_t * pIalpha,
        q31_t * pIbeta)
{
...
__STATIC_INLINE void arm_inv_clarke_f32(float32_t Ialpha, float32_t Ibeta,
...
__STATIC_INLINE void arm_inv_clarke_q31(q31_t Ialpha, q31_t Ibeta, q31_t * pIa,
        q31_t * pIb)
{
    q31_t product1, product2; /* Temporary variables used to store intermediate results */
...
__STATIC_INLINE void arm_park_f32(float32_t Ialpha, float32_t Ibeta,
...
__STATIC_INLINE void arm_park_q31(q31_t Ialpha, q31_t Ibeta, q31_t * pId,
...
__STATIC_INLINE void arm_inv_park_f32(float32_t Id, float32_t Iq,
...
__STATIC_INLINE void arm_inv_park_q31(q31_t Id, q31_t Iq, q31_t * pIalpha,
...
__STATIC_INLINE q31_t arm_linear_interp_q31(q31_t * pYData, q31_t x,
        uint32_t nValues)
{
    q31_t y; /* output */
...
__STATIC_INLINE void arm_circularWrite_f32(int32_t * circBuffer, int32_t L,
 ...
 */
__STATIC_INLINE void arm_circularRead_f32(int32_t * circBuffer, int32_t L,
        int32_t * readOffset, int32_t bufferInc, int32_t * dst,
        int32_t * dst_base, int32_t dst_length, int32_t dstInc,
        uint32_t blockSize)
{
    uint32_t i = 0u;
...
__STATIC_INLINE void arm_circularWrite_q15(q15_t * circBuffer, int32_t L,
 ...
 */
__STATIC_INLINE void arm_circularRead_q15(q15_t * circBuffer, int32_t L,
...
__STATIC_INLINE void arm_circularWrite_q7(q7_t * circBuffer, int32_t L,
 ...
 */
__STATIC_INLINE void arm_circularRead_q7(q7_t * circBuffer, int32_t L,
