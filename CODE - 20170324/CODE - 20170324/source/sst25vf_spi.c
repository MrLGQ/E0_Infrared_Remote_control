...
void sFLASH_SPI_Init(void)
{
  ...
  RCC_APB2PeriphClockCmd(sFLASH_MEM_CS_GPIO_CLK | sFLASH_SPI_MOSI_GPIO_CLK | 
...
void sFLASH_Init(void)
{
  ...
  if(Device_ID == sFLASH_SST25VF040_ID || Device_ID == sFLASH_SST25VF016_ID || Device_ID == sFLASH_SST25VF032_ID)
  {
...
int sFLASH_SelfTest(void)
{
  ...
  if(FlashID == sFLASH_SST25VF040_ID || FlashID == sFLASH_SST25VF016_ID || FlashID == sFLASH_SST25VF032_ID)
  {
